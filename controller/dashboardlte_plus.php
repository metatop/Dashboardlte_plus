 ...
 * @Modificado por Tronico para añadir Trimestre anterior <tronico@gmail.com>
 */
...
class dashboardlte_plus extends fs_controller
{
   public $presupuestos;
   public $pedidos;
   public $albaranes;
   ...
   {
      parent::__construct(__CLASS__, 'DashboardLTE_Plus', 'ventas');
   }
   ...
   protected function private_core()
   {
      ...
      else if($this->intervalo == 'trimestre-anterior')
      {
           $FechaActual = new DateTime("now");  
           $FechaActual->sub(new DateInterval('P1Y'));
           $this->desde = $FechaActual->format('01-10-Y');
           $this->hasta = $FechaActual->format('31-12-Y');
           //$this->desde = date('01-10-2017');
           //$this->hasta = date('31-12-2017');
    ...
    {      
      //$FechaActual = new DateTime("now");  
      //$FechaActual->sub(new DateInterval('P1Y'));
      $this->imp_desde = $FechaActual->format('01-10-Y');
      $this->imp_hasta = $FechaActual->format('31-12-Y');
      //$this->imp_desde = date('01-10-2017');
      //$this->imp_hasta = date('31-12-2017');
